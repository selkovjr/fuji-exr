...
namespace termcolor {
  ...
  inline std::ostream& lightgrey(std::ostream& stream) {
    if (_internal::is_atty(stream)) {
#if defined(TERMCOLOR_OS_MACOS) || defined(TERMCOLOR_OS_LINUX)
  ...
  inline std::ostream& lightred(std::ostream& stream) {
    if (_internal::is_atty(stream)) {
#if defined(TERMCOLOR_OS_MACOS) || defined(TERMCOLOR_OS_LINUX)
  ...
  inline std::ostream& lightgreen(std::ostream& stream) {
    if (_internal::is_atty(stream)) {
#if defined(TERMCOLOR_OS_MACOS) || defined(TERMCOLOR_OS_LINUX)
  ...
  inline std::ostream& lightblue(std::ostream& stream) {
    if (_internal::is_atty(stream)) {
#if defined(TERMCOLOR_OS_MACOS) || defined(TERMCOLOR_OS_LINUX)
  ...
  inline std::ostream& lightmagenta(std::ostream& stream) {
    if (_internal::is_atty(stream)) {
#if defined(TERMCOLOR_OS_MACOS) || defined(TERMCOLOR_OS_LINUX)
  ...
  // Since C++ doesn't have a way to encapsulate code in the header I have to
  // introduce this namespace to protect private code
  namespace _internal {
    // Since C++ does not provide a way to extract a file handle
    // from an stream object, I have to use this hack.
    inline FILE* get_standard_stream(const std::ostream& stream) {
      if (&stream == &std::cout)
        return stdout;
    ...
    // Test whether this stream is connected to a terminal
    inline bool is_atty(const std::ostream& stream) {
